//! Embedded web server for browser mode
//!
//! Provides API endpoints on port 25092 that mirror the Tauri invoke commands,
//! allowing the same React app to work in browser mode.
//!
